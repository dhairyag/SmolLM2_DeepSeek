...
def load_and_prepare_data(tokenizer, batch_size=8):
...
def main():
    try:
        ...
        # Training parameters updated for longer training
        optimizer = AdamW(model.parameters(), lr=3e-4)
        num_steps = 10000  # Updated from 5000 to 10000 steps
        ...
        while step < num_steps:
            try:
                ...
                if step % checkpoint_interval == 0 and step > 0:
                    for prompt in ["Once upon a time", "In a galaxy far away"]:
        ...
        # After training, generate five sample outputs with different prompts.
        prompts = [
            "Once upon a time",
            "The future of AI is",
